...
// This modifies values each time a button is cliked on
...
function Handle_Operator(Next_Operator) {
    ...
    //checks if an operator already exists and if Wait_Second_Operand is
    // true, then updates the operator an exits from the function
...
// Ensures that AC clears all point from the Calculator scteen
